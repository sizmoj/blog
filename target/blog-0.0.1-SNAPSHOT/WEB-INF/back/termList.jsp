...
<script type="text/javascript">
	$(document).ready(function(){
		$("#add").click(function(){
			window.location = "${ctx}/back/addTerm";
		});
	});
</script>
</head>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">	
			...
			<div class="panel-heading">
				<button id="add" type="button" class="btn btn-default">添加文章类别</button>
			</div>
			<div class="col-lg-12">
					...
					<table class="table table-striped table-bordered table-hover"
						...
						<c:forEach items="${terms}" var="term">
							<tr class="odd gradeX">
								...
								<td>${term.name}</td>
								<th>
									<a href="${ctx}/back/updateTerm?id=${term.id}">更新</a>
									<a href="${ctx}/back/deleteTerm?id=${term.id}">删除</a>
								</th>
							</tr>
						</c:forEach>
						</tbody>
